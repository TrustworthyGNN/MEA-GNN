...
# 
# print("Accuracy: " + str(acc1))
# th.save(net_sub_attack_3.state_dict(), "./models/attack_6_cora_attack_3_model_all_shadow.pkl")
# =============================================================================
...
# model_sub_attack_2.load_state_dict(th.load("./models/attack_6_cora_attack_2_model_all_shadow_6931.pkl"))
# model_sub_attack_2.eval()
# 
# model_sub_attack_3 = Net_sub_attack_3()
# model_sub_attack_3.load_state_dict(th.load("./models/attack_6_cora_attack_3_model_all_shadow_7750.pkl"))
...
# 
# optimizer_attack_6 = th.optim.Adam(net_attack_6.parameters(), lr=1e-2, weight_decay=5e-4)
...
# 
# th.save(net_attack_6.state_dict(), "./models/attack_6_cora_attack_6_model_correct_all_shadow.pkl")
# 
# #read attack-2 model
# model_attack_2 = Net_attack_2()
# model_attack_2.load_state_dict(th.load("./models/attack_6_cora_attack_2_model_no_sub_7429.pkl"))
# model_attack_2.eval()
# 
# #read attack-3 model
# model_attack_3 = Net_attack_3()
# model_attack_3.load_state_dict(th.load("./models/attack_3_subgraph_shadow_model_cora_81584.pkl"))
# model_attack_3.eval()
# 
# #generate the parameters
# shadow_graph_index = []
# fileObject = open('./data/cora/protential_1300_shadow_graph_index.txt', 'r')
# contents = fileObject.readlines()
# for ip in contents:
#     shadow_graph_index.append(int(ip))
# fileObject.close()
...
# 
# model = Net()
# model.load_state_dict(th.load("./models/improved_target_model_cora_new_test.pkl"))
# model.eval()
# 
# 
