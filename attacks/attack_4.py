...
sub_graph_index_b = []
fileObject = open('./data/target_graph_index.txt', 'r')
...
sub_graph_index_a = []
fileObject = open('./data/protential_1200_shadow_graph_index.txt', 'r')
contents = fileObject.readlines()
for ip in contents:
...
net1.load_state_dict(th.load("./models/attack_3_subgraph_shadow_model_cora.pkl"))
