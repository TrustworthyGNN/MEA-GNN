...
# model_sub_attack_2.load_state_dict(th.load("./models/attack_6_pubmed_attack_2_model_all_shadow_6931.pkl"))
# model_sub_attack_2.eval()
# 
# model_sub_attack_3 = Net_sub_attack_3()
# model_sub_attack_3.load_state_dict(th.load("./models/attack_6_pubmed_attack_3_model_all_shadow_7750.pkl"))
...
# model_attack_2.load_state_dict(th.load("./models/attack_6_pubmed_attack_2_model_no_sub_7429.pkl"))
# model_attack_2.eval()
# 
# #read attack-3 model
# model_attack_3 = Net_attack_3()
# model_attack_3.load_state_dict(th.load("./models/attack_3_subgraph_shadow_model_pubmed_81584.pkl"))
# model_attack_3.eval()
# 
...
# 
# model = Net()
# model.load_state_dict(th.load("./models/improved_target_model_pubmed_new_test.pkl"))
# model.eval()
# 
# 
